...
export default function DmcaPage() {
  return (
    <LegalPage
      ...
      description="How copyright holders can submit takedown requests to LumenNovel under the DMCA."
      path="/dmca"
    >
      <p>
        LumenNovel respects the intellectual property rights of others and expects users of our platform to
      ...
      <p>
        All content hosted on LumenNovel, including novel text, covers, and other materials, is the property
      ...
      <p>
        ...
        <a href="mailto:dmca@lumennovel.example">dmca@lumennovel.example</a> containing the following
        information:
      </p>
      <ul>
        <li>A physical or electronic signature of the copyright owner or a person authorized to act on their behalf.</li>
        <li>Identification of the copyrighted work you claim has been infringed.</li>
        <li>Identification of the specific URL(s) or content on LumenNovel that you believe is infringing.</li>
      ...
      <p>
        ...
        <a href="mailto:dmca@lumennovel.example">dmca@lumennovel.example</a> that includes:
      </p>
      <ul>
      ...
      <p>
        ...
        <a href="mailto:copyright@lumennovel.example">copyright@lumennovel.example</a>.
      </p>
    </LegalPage>
  );
}
