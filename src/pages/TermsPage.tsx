...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      description="The terms and conditions for using LumenNovel, including usage rules, intellectual property, and liability."
      path="/terms"
    >
      <p>
        These Terms of Service ("Terms") govern your use of the LumenNovel website (the "Service"). By
      ...
      <h2>Website Usage</h2>
      <p>
        LumenNovel provides a free online platform for reading serialized web novels. You may browse,
      ...
      <p>By using LumenNovel, you agree to:</p>
      <ul>
      ...
      <p>
        All content on LumenNovel, including text, covers, logos, and design, is owned by LumenNovel or its
      ...
      <p>
        To the fullest extent permitted by law, LumenNovel and its operators shall not be liable for any
